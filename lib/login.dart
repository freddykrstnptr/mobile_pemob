...
import 'package:mobile_pemob/home.dart';
import 'package:mobile_pemob/register.dart';
...
class _LoginState extends State<Login> {
  ...
  String correctEmail = "freddy@gmail.com";
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text("Selamat Datang",style: TextStyle(color: Color.fromRGBO(240, 120, 38, 1), fontSize: 40),),
                    SizedBox(height: 10,),
                    Text("Mobile Calculate!",style: TextStyle(color: Color.fromRGBO(240, 120, 38, 1), fontSize: 18),)
                  ],
                ),
              ),
              SizedBox(height: 20,),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      InkWell(
                        onTap: () {
                          String enteredEmail = "freddy@gmail.com";
