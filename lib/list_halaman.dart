...
import 'package:mobile_pemob/panjang_screen.dart';import 'package:mobile_pemob/suhu_screen.dart';
import 'package:mobile_pemob/uang_screen.dart';class ListHalaman extends StatefulWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: Color.fromRGBO(240, 120, 38, 1),
        ),
        body: Padding(
