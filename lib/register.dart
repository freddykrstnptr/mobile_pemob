import 'package:mobile_pemob/login.dart';
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text("Daftar",style: TextStyle(color: Color.fromRGBO(240, 120, 38, 1), fontSize: 40),),
                    SizedBox(height: 10,),
                    Text("Buat Akun Baru",style: TextStyle(color: Color.fromRGBO(240, 120, 38, 1), fontSize: 18),)
                  ],
                ),
              ),
              SizedBox(height: 20,),
